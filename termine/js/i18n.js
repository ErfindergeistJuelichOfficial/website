...
const translations = {
  de: {
    ...
    'events.source.post':  'Endpunkt — direkt aus der Datenbank, ohne Zwischenspeicherung. Das JSON ist stark vereinfacht dargestellt, um das Prinzip leichter verständlich zu machen. Trau dich: Verändere die LIVE-Daten im Editor rechts und schau was passiert!',
    ...
    'plugin.events.challenge':     'Kannst du den Titel des dritten Events finden? Klicke hier für die Lösung.',
  ...
  en: {
    ...
    'events.source.post':  'endpoint — directly from the database, no caching. The JSON is heavily simplified to make the concept easier to understand. Go ahead: edit the LIVE data in the editor on the right and see what happens!',
    ...
    'plugin.events.challenge':     'Can you find the title of the third event? Click here for the solution.',
