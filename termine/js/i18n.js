...
const translations = {
  de: {
    ...
    'downloads.new.tab': 'Öffnet in neuem Tab',
    ...
    'json.learnmore': 'Mehr über JSON auf W3Schools',
    ...
    'rest.learnmore': 'Mehr über REST APIs auf W3Schools',

    'ha.title': 'Home Assistant',
    'ha.subtitle': 'Der /tomorrow Endpunkt',
    'ha.description': 'Der /tomorrow Endpunkt gibt nur die Termine von morgen zurück — perfekt für Smart-Home-Automationen. Kein Filtern, kein Suchen: direkt die relevanten Daten.',
    'ha.usecase': 'Beispiel: Lass deinen Smart Speaker jeden Abend ansagen, ob morgen ein Termin beim Erfindergeist stattfindet.',
    'ha.endpoint.label': 'Tomorrow Endpunkt öffnen',
    'ha.yaml.title': 'Beispiel Home Assistant Automation:',
  ...
  en: {
    ...
    'downloads.new.tab': 'Opens in new tab',
    ...
    'json.learnmore': 'Learn more about JSON on W3Schools',
    ...
    'rest.learnmore': 'Learn more about REST APIs on W3Schools',

    'ha.title': 'Home Assistant',
    'ha.subtitle': 'The /tomorrow Endpoint',
    'ha.description': "The /tomorrow endpoint returns only tomorrow's events — perfect for smart home automations. No filtering, no searching: directly the relevant data.",
    'ha.usecase': "Example: Have your smart speaker announce each evening whether there's an Erfindergeist event tomorrow.",
    'ha.endpoint.label': 'Open Tomorrow endpoint',
    'ha.yaml.title': 'Example Home Assistant Automation:',
