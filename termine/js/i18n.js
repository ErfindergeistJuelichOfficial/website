...
const translations = {
  de: {
    ...
    'events.source.post':  'Endpunkt — direkt aus der Datenbank, ohne Zwischenspeicherung. Das JSON ist stark vereinfacht dargestellt, um das Prinzip leichter verständlich zu machen. Trau dich: Verändere die LIVE-Daten im Editor und schau was passiert!',
    'events.json.explain.intro': 'Ein JSON-Objekt ist wie eine Box mit beschrifteten Fächern:',
    'events.json.explain.obj':   'Objekt — die Box selbst',
    'events.json.explain.key':   'Schlüssel — das Etikett des Fachs',
    'events.json.explain.val':   'Wert — was drin steckt',
  ...
  en: {
    ...
    'events.source.post':  'endpoint — directly from the database, no caching. The JSON is heavily simplified to make the concept easier to understand. Go ahead: edit the LIVE data in the editor and see what happens!',
    'events.json.explain.intro': 'A JSON object is like a box with labeled slots:',
    'events.json.explain.obj':   'Object — the box itself',
    'events.json.explain.key':   'Key — the label on the slot',
    'events.json.explain.val':   'Value — what\'s inside',
