...
const translations = {
  de: {
    ...
    'arch.node.tomorrow': '/tomorrow',
    'arch.node.pdf': 'PDF Dateien',
    'arch.node.share': 'Share Server',
    'arch.node.calendar': 'Persönliche Kalender',
    'arch.node.ha': 'Home Assistant',
    'arch.node.thissite': 'Diese Seite',
  ...
  en: {
    ...
    'arch.node.share': 'Share Server',
    'arch.node.calendar': 'Personal Calendars',
    'arch.node.ha': 'Home Assistant',
    'arch.node.thissite': 'This Website',
